...
internal class MoviesRepositoryTest {
    ...
    fun getMovieDetail() {
        runBlocking {
            ...
            Assert.assertEquals(
                movieDetailResponse.languages.size,
                movieDetailResult.languages.size
            )
    ...
    @Test
    fun getMovieFromDb_invalidMovieId_returnsNullMovieDetail() {
        runBlocking {
    ...
    fun getFavouriteMovies() {
        val favouriteMovieList: LiveData<List<FavouriteMovie>> =
            MutableLiveData(
                listOf(
                    favouriteMovie,
